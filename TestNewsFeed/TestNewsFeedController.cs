...
{
    public class TestNewsFeedController
    {
        ...
        [Test]
        public async Task TestNewStories()
        {

            //Act

            //Arrange
            _storyService.Setup(s => s.GetNewStories()).ReturnsAsync(stories);

            //Assert
            var result = await storiesController.Get();
